...
public class HgCommandExecutor
{
			...
			@Nullable final List<String> arguments)
	{
		...
		{ // this may happen during project closing, no need to notify the user.
			LOG.info(e.getMessage(), e);
			return null;
		}
	}
	...
	protected void showError(Exception e)
	{
		...
		VcsImplUtil.showErrorMessage(myProject, message.toString(), HgVcsMessages.message("hg4idea.error"));
	}
}
