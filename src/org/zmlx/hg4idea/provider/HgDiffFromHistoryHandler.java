...
/**
 * {@link com.intellij.openapi.vcs.history.DiffFromHistoryHandler#showDiffForTwo(com.intellij.openapi.vcs.FilePath,
 * com.intellij.openapi.vcs.history.VcsFileRevision, com.intellij.openapi.vcs.history.VcsFileRevision) "Show Diff" for 2 revision} calls the common
 * code.
 *
...
public class HgDiffFromHistoryHandler implements DiffFromHistoryHandler
{
	...
	private void showDiffForDirectory(@NotNull final FilePath path, @Nullable final HgFileRevision rev1, @Nullable final HgFileRevision rev2)
	{
		...
		calculateDiffInBackground(root, path, rev1, rev2, new Consumer<List<Change>>()
		{
			...
			{
				showDirDiffDialog(path, rev1 != null ? rev1.getRevisionNumber().getChangeset() : null, rev2 != null ? rev2.getRevisionNumber()
						.getChangeset() : null, changes);
			}
		});
	}
	...
	private void calculateDiffInBackground(@NotNull final VirtualFile root,
