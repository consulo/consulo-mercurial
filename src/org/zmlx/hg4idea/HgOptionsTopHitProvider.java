	...
	public Collection<BooleanOptionDescription> getOptions(@Nullable Project project)
	{
		if(project != null)
		{
			for(VcsDescriptor descriptor : ProjectLevelVcsManager.getInstance(project).getAllVcss())
			{
				...
				{
					return Collections.unmodifiableCollection(Arrays.asList(option(project, "Mercurial: Check for incoming and outgoing changesets",
							"isCheckIncomingOutgoing", "setCheckIncomingOutgoing"), option(project, "Mercurial: Ignore whitespace differences in " +
							"annotations", "isWhitespacesIgnoredInAnnotations", "setIgnoreWhitespacesInAnnotations")));
				}
			}
		}
