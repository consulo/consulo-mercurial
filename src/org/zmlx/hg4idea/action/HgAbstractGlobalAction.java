...
public abstract class HgAbstractGlobalAction extends AnAction
{
	...
	public void actionPerformed(@NotNull AnActionEvent event)
	{
		...
		{
			List<HgRepository> selectedRepositories = (files == null || files.length == 0) ? Collections.singletonList(HgUtil.getCurrentRepository
					(project)) : HgActionUtil.collectRepositoriesFromFiles(repositoryManager, Arrays.asList(files));
