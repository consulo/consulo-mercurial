...
public class HgRepositoryImpl extends RepositoryImpl implements HgRepository
{
	...
	private HgRepoInfo readRepoInfo()
	{
		...
		return new HgRepoInfo(myReader.readCurrentBranch(), myReader.readCurrentRevision(), myReader.readCurrentTipRevision(), myReader.readState(),
				myReader.readBranches(), myReader.readBookmarks(), myReader.readCurrentBookmark(), myReader.readTags(), myReader.readLocalTags(),
