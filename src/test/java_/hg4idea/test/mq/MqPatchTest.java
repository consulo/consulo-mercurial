...
public abstract class MqPatchTest extends HgPlatformTest {
  ...
  private TimedVcsCommit getLastRevisionDetails() throws VcsException
  {
    ...
    return (TimedVcsCommit)ContainerUtil.getFirstItem(HgHistoryUtil.readAllHashes(myProject, myRepository, consulo.ide.impl.idea.util.Consumer.EMPTY_CONSUMER,
                                                                  Arrays.asList("-r", "tip")));
  }
